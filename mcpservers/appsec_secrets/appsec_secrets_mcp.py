"""
Secrets MCP Server - Secret Scanning Tools
...
logger = setup_logger(__name__, log_file_path="logs/appsec_secrets_mcp.log")


def main():
    """Run Secrets MCP server."""
    server_dir = Path(__file__).parent
    tools_dir = server_dir / "tools"
    logger.info("Starting Secrets MCP Server...")
    server = AppSecBaseServer("appsec-secrets-mcp", tools_dir)
    server.run()
