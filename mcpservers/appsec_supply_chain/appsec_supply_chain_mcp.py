...
logger = setup_logger(__name__, log_file_path="logs/appsec_supply_chain_mcp.log")


def main():
    """Run Supply Chain Security MCP server."""
    server_dir = Path(__file__).parent
    tools_dir = server_dir / "tools"
    logger.info("Starting Supply Chain Security MCP Server...")
    server = AppSecBaseServer("appsec-supply-chain-mcp", tools_dir)
    server.run()
