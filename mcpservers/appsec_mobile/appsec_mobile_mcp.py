...
logger = setup_logger(__name__, log_file_path="logs/appsec_mobile_mcp.log")


def main():
    """Run Mobile Security MCP server."""
    server_dir = Path(__file__).parent
    tools_dir = server_dir / "tools"
    logger.info("Starting Mobile Security MCP Server...")
    server = AppSecBaseServer("appsec-mobile-mcp", tools_dir)
    server.run()
