"""
Kubernetes Security MCP Server
...
logger = setup_logger(__name__, log_file_path="logs/appsec_k8s_mcp.log")


def main():
    """Run Kubernetes Security MCP server."""
    server_dir = Path(__file__).parent
    tools_dir = server_dir / "tools"
    logger.info("Starting Kubernetes Security MCP Server...")
    server = AppSecBaseServer("appsec-k8s-mcp", tools_dir)
    server.run()
